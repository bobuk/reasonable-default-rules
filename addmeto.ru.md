...
8. Попытка потребовать от окружающих что-то вам **объяснить**, особенно если это что-то является справочной **информацией доступной в интернете**, это явная охота за вниманием, постарайтесь этого ибзегать.
