...
Разверну смысл: **мы** (сообщество участников чата) **стараемся** (отступления от правил возможны, но не могут быть регулярными) держатать чат как **информационную** (нацеленную на обмен информацией, а не эмоциями нарпимер) и **дискуссионную** (где участники пытаются совместно придти к истине) площадку для **всех** (мы не дискриминируем людей и носителей другого интелекта по любому признаку), а не место для **демонстрации** (т.е. целенаправленного проявления) своего **превосходства** (возвеличивания себя, в том числе и через унижение других) над другими.
